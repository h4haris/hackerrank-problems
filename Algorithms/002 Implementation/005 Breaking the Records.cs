...
// The below depicts the number of times Maria broke her best and worst records throughout the season:
...
class Result
{
    ...
    public static List<int> breakingRecords(List<int> scores)
    {
        ...
        int highestScore = scores[0]; // Highest Score
        int LowestScore  = scores[0]; // Lowest Score
