...
var regexPattern = /\/\/.+$|\/\*[\s\S]*?\*\//gm

function processData(input) {
    const matches = input.match(regexPattern);
    matches.forEach((x) => console.log(x.replace(/^\s*/gm,'')));
}
...
processData(` /*This is a program to calculate area of a circle after getting the radius as input from the user*/
#include<stdio.h>
int main()
{
   double radius,area;//variables for storing radius and area
